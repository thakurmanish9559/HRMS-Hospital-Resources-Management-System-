...
import com.example.hrmsapplication.DatabaseHelper;
import com.example.hrmsapplication.Write_Report;
import com.example.hrmsapplication.Message;
import com.example.hrmsapplication.R;
...
public class View_Report extends AppCompatActivity {
    ...
    ListView lv_report = (ListView) findViewById(R.id.lv_reports);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (y.moveToFirst()) {
            ...
            Message.message( "Sorry You have No Reports Right, Now");
            finish();
        }
