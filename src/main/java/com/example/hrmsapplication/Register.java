...
import com.example.hrmsapplication.Desktop_Admin;
import com.example.hrmsapplication.Doctor;
import com.example.hrmsapplication.Patient;
import com.example.hrmsapplication.Staff_Member;
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fnames.equals("") || lnames.equals("") || ages.equals("") || dds.equals("") ||
                    ...
                    Message.message( "Please Fill in all your Details");
                } else {
                    ...
                    if (y.moveToFirst()) {
                        ...
                        Message.message( "Login With Your Username and Password");
                        finish();
                    } else {
